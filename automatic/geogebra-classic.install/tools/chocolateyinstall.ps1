...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-911-3.msi'
$version = [version]'6.0.911.3'
...
$packageArgs = @{
    ...
    checksum       = '9d4902f12f72c686c23bc50257ef19d82b122cb360742db856654680c16dd781'
    checksumType   = 'sha256'
