...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-899-0.msi'
$version = [version]'6.0.899.0'
...
$packageArgs = @{
    ...
    checksum       = 'bd7988ef797de928308d84271123a51140fc57b6aa943b53bf49284db2df3420'
    checksumType   = 'sha256'
