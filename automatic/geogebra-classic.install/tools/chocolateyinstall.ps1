...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-843-0.msi'
$version = [version]'6.0.843.0'
...
$packageArgs = @{
    ...
    checksum       = 'eccf5fa4f0f06992e312638ad597f94c68c7c4c2a62fcfc1c6204cb389effbd2'
    checksumType   = 'sha256'
