...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-907-0.msi'
$version = [version]'6.0.907.0'
...
$packageArgs = @{
    ...
    checksum       = '6ad0b9d4fa5894108f61c705240f389147fa71ab70173cba1ed6a5c7f4e5b634'
    checksumType   = 'sha256'
