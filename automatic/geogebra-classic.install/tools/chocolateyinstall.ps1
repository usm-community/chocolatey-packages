...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-836-0.msi'
$version = [version]'6.0.836.0'
...
$packageArgs = @{
    ...
    checksum       = '4372c9c8ca6ff9ddf692559aa945aaf62c714e763762ea5082af32f2fcc4b40b'
    checksumType   = 'sha256'
