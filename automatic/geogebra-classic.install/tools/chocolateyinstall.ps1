...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-919-1.msi'
$version = [version]'6.0.919.1'
...
$packageArgs = @{
    ...
    checksum       = 'a79ab68d95e051abab4269a52afc218bbd1ba8c5885be5f789d61a3fff2d193b'
    checksumType   = 'sha256'
