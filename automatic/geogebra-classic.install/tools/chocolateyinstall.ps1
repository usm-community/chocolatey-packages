...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-857-0.msi'
$version = [version]'6.0.857.0'
...
$packageArgs = @{
    ...
    checksum       = '2aa08f235999759bdd568e8e3e5ebe7b7cf138875a592e6ad4e9dbc136dcf40d'
    checksumType   = 'sha256'
