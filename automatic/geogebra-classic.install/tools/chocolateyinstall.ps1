...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-916-2.msi'
$version = [version]'6.0.916.2'
...
$packageArgs = @{
    ...
    checksum       = '3058bcc56d133669f5b96862776e430f6959a666e01e29fd5707977b39f15046'
    checksumType   = 'sha256'
