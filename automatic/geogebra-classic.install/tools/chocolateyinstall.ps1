...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-904-2.msi'
$version = [version]'6.0.904.2'
...
$packageArgs = @{
    ...
    checksum       = 'a660bc32c45dd0821db50e6666bbc243ead96a1257e9005088b0dc5ff5192185'
    checksumType   = 'sha256'
