...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-876-0.msi'
$version = [version]'6.0.876.0'
...
$packageArgs = @{
    ...
    checksum       = '31d36906156db0cedd0897563ea084588dc1cba30d13023e7a59d71f8e04ba4f'
    checksumType   = 'sha256'
