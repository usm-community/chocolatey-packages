...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-913-0.msi'
$version = [version]'6.0.913.0'
...
$packageArgs = @{
    ...
    checksum       = '5419a4062bb583b5b14cb59d65444ce635b8c7d54a177eee5eaa2c95f9cc3ef9'
    checksumType   = 'sha256'
