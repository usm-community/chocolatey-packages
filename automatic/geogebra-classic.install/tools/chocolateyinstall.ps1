...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-909-9.msi'
$version = [version]'6.0.909.9'
...
$packageArgs = @{
    ...
    checksum       = 'dc59a35a537ca4281b682e62b6a886a877c33443691bddbf1623ff3cd07dbdd3'
    checksumType   = 'sha256'
