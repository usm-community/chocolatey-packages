...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-871-0.msi'
$version = [version]'6.0.871.0'
...
$packageArgs = @{
    ...
    checksum       = '44fa2d17f4d1960fe408527a4db9292d37f043db163b60ec5dd1a043f9a7926a'
    checksumType   = 'sha256'
