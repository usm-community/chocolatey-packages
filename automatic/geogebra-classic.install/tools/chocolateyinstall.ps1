...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-902-0.msi'
$version = [version]'6.0.902.0'
...
$packageArgs = @{
    ...
    checksum       = '09603d7fa26762c5dfa54626badd314847c5ac5bb099d06dfed2e2f4f78824a1'
    checksumType   = 'sha256'
