...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-918-0.msi'
$version = [version]'6.0.918.0'
...
$packageArgs = @{
    ...
    checksum       = '54389cab246e69568aeb9e9cb35f39858c4194673b2139a5d8bc3a156c730f1b'
    checksumType   = 'sha256'
