...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-905-1.msi'
$version = [version]'6.0.905.1'
...
$packageArgs = @{
    ...
    checksum       = 'd4160919a2c47a0fcd9512ea786c7f376461b15ad75c7acf97c6c768d6b79885'
    checksumType   = 'sha256'
