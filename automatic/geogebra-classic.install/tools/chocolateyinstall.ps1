...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-830-0.msi'
$version = [version]'6.0.830.0'
...
$packageArgs = @{
    ...
    checksum       = '3939ffd455f73e01cdb99526bc2f87d5811a01f00dda00a5f2c41341e8cc5bef'
    checksumType   = 'sha256'
