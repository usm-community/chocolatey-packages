...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-929-3.msi'
$version = [version]'6.0.929.3'
...
$packageArgs = @{
    ...
    checksum       = '7b30f1f24cc9bf3d87c743949c3b3eda557e56c14f6cfc97b3cdeb7d5c7f0f31'
    checksumType   = 'sha256'
