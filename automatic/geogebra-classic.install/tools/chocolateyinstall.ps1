...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-840-0.msi'
$version = [version]'6.0.840.0'
...
$packageArgs = @{
    ...
    checksum       = '52e6b474088351fc15cf251c43d8152add9a8ebaa39e934077f80cb700e4566a'
    checksumType   = 'sha256'
