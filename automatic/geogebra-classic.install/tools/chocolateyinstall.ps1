...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-903-0.msi'
$version = [version]'6.0.903.0'
...
$packageArgs = @{
    ...
    checksum       = '4381dfc2d17664dfacb6847a9ec2a5c1cb07d35c806b97279895840c025a6c0e'
    checksumType   = 'sha256'
