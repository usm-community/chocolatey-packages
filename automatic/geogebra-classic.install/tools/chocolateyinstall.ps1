...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-811-0.msi'
$version = [version]'6.0.811.0'
...
$packageArgs = @{
    ...
    checksum       = '8323d9678d8ce2d592c85401b762e7e56877cd0712ed38ef8d8fbf2aea1ccfdc'
    checksumType   = 'sha256'
