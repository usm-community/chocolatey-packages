...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-820-0.msi'
$version = [version]'6.0.820.0'
...
$packageArgs = @{
    ...
    checksum       = '031312d60b89b905f809a1656227285a0e91e65656edceb07b9d9653b31aa1f0'
    checksumType   = 'sha256'
