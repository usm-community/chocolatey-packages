...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-901-1.msi'
$version = [version]'6.0.901.1'
...
$packageArgs = @{
    ...
    checksum       = '606222aff3e5d0654a88b5b6a0c3f1ad10eea30781903df4b6f129775a122249'
    checksumType   = 'sha256'
