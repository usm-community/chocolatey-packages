...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-760-0.msi'
$version = [version]'6.0.760.0'
...
$packageArgs = @{
    ...
    checksum       = '8ac09013920a9973705312b25c416942229c4fbee6de3f938cd655df9a77350d'
    checksumType   = 'sha256'
