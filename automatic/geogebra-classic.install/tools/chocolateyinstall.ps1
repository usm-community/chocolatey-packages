...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-770-0.msi'
$version = [version]'6.0.770.0'
...
$packageArgs = @{
    ...
    checksum       = '095ade92f711832b3d2098dd379e2961c44109a76bc008a002e96f8c08011975'
    checksumType   = 'sha256'
