...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-906-2.msi'
$version = [version]'6.0.906.2'
...
$packageArgs = @{
    ...
    checksum       = '5e6e6a89b6139ddba02fd9bce4dbbf3c158fd7ad9bcf124c0024c70e56fd086b'
    checksumType   = 'sha256'
