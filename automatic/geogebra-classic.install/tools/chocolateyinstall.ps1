...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-898-1.msi'
$version = [version]'6.0.898.1'
...
$packageArgs = @{
    ...
    checksum       = 'bbc1079131e8d05fe2eca1e39f6e4ab9ca594c3f58d9b20d6a42aad8dc12d374'
    checksumType   = 'sha256'
