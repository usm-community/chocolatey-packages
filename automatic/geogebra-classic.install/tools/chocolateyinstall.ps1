...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-807-0.msi'
$version = [version]'6.0.807.0'
...
$packageArgs = @{
    ...
    checksum       = '8652107be22296a6eac3be577509bff33f2cf0b44b5403edc432ae7b14d3545c'
    checksumType   = 'sha256'
