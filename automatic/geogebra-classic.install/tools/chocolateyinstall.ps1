...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-851-0.msi'
$version = [version]'6.0.851.0'
...
$packageArgs = @{
    ...
    checksum       = '13b7346e78b8ec458061d11e92f72f3c708373bdf41933acd145610b54bd878b'
    checksumType   = 'sha256'
