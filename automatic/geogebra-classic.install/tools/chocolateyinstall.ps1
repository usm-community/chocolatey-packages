...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-864-0.msi'
$version = [version]'6.0.864.0'
...
$packageArgs = @{
    ...
    checksum       = '815046a7f2dd14cc51922fd3083cc10e13370d75c4effc08c5a1e9c7dbfe37c7'
    checksumType   = 'sha256'
