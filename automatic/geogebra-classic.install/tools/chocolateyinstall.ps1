...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-829-0.msi'
$version = [version]'6.0.829.0'
...
$packageArgs = @{
    ...
    checksum       = '0ef45431f602e80c76a7a81c0bcc968551e979092e820e7c80cbe0c6e8df7241'
    checksumType   = 'sha256'
