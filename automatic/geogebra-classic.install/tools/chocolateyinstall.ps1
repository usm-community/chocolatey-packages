...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-826-0.msi'
$version = [version]'6.0.826.0'
...
$packageArgs = @{
    ...
    checksum       = 'fe492f3c864f34a2824a3322464cc538431e9737bf62c2072c3ad6f8e59da1b8'
    checksumType   = 'sha256'
