...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-802-0.msi'
$version = [version]'6.0.802.0'
...
$packageArgs = @{
    ...
    checksum       = '6933de3913f247fca9cad8288801e1237ada6b3c56d050a43cfa37899caf1de4'
    checksumType   = 'sha256'
