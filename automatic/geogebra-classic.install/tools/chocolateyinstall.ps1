...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-793-0.msi'
$version = [version]'6.0.793.0'
...
$packageArgs = @{
    ...
    checksum       = '129cc35a023b32e7298401e789f46c3ba30d8a9b1e15410fa2bca085c891371e'
    checksumType   = 'sha256'
