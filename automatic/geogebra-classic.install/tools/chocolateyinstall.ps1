...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-841-0.msi'
$version = [version]'6.0.841.0'
...
$packageArgs = @{
    ...
    checksum       = '24ad52249e7586dafad6d9340da6a19115f7fe9869afa657e651ac0b0e869fc3'
    checksumType   = 'sha256'
