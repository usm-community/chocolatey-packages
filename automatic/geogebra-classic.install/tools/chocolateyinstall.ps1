...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-915-1.msi'
$version = [version]'6.0.915.1'
...
$packageArgs = @{
    ...
    checksum       = 'dcd06d929b432b2440f49626de7179bbf33c56b8d25a661889a4b437a84ae8f4'
    checksumType   = 'sha256'
